...
public class FetchDataByPrice {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		ResultSet resultSet= statement.executeQuery("select * from duster where price=25" );
		...
		connection.close();
		System.out.println("Successfully fetched the data by price");
